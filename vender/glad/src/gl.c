...
static void glad_gl_load_GL_VERSION_ES_CM_1_0(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_SC_VERSION_2_0(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static int glad_gl_find_extensions_gles1(GladGLContext *context, int version) {
    const char *exts = NULL;
    unsigned int num_exts_i = 0;
    char **exts_i = NULL;
    if (!glad_gl_get_extensions(context, version, &exts, &num_exts_i, &exts_i)) return 0;
...
static int glad_gl_find_core_gles1(GladGLContext *context) {
    int i;
    const char* version;
    const char* prefixes[] = {
        "OpenGL ES-CM ",
...
int gladLoadGLES1ContextUserPtr(GladGLContext *context, GLADuserptrloadfunc load, void *userptr) {
    int version;
...
int gladLoadGLES1Context(GladGLContext *context, GLADloadfunc load) {
...
static int glad_gl_find_extensions_glsc2(GladGLContext *context, int version) {
    const char *exts = NULL;
    unsigned int num_exts_i = 0;
    char **exts_i = NULL;
    if (!glad_gl_get_extensions(context, version, &exts, &num_exts_i, &exts_i)) return 0;
...
static int glad_gl_find_core_glsc2(GladGLContext *context) {
    int i;
    const char* version;
    const char* prefixes[] = {
        "OpenGL ES-CM ",
...
int gladLoadGLSC2ContextUserPtr(GladGLContext *context, GLADuserptrloadfunc load, void *userptr) {
    int version;
...
int gladLoadGLSC2Context(GladGLContext *context, GLADloadfunc load) {
